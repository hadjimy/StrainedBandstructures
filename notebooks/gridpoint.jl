...
# ╔═╡ 9f4544e2-6699-11ed-1b62-b7e4919ad83d
begin
...
# ╔═╡ bf3b4a1f-f6ec-440e-b276-3ef2e9e3073e
...
# ╔═╡ 0fc5a358-34ee-4abe-9853-c427193fdf0c
grid = triangulation_of_domain_with_subregions()

# ╔═╡ 621744ae-b33e-4fa9-8268-c7a292b50798
let
    gridvis = GridVisualizer(Plotter=PyPlot,dim=2)
    gridplot!(gridvis,grid)
    ax = gridvis.subplots[1][:ax]
	ptx = grid[Coordinates][1,11]
	pty = grid[Coordinates][2,11]
	# plot a thick red dot at given node
    ax.scatter(ptx,pty,linewidths=0.1,color="red",zorder=2) 
    reveal(gridvis)
end

# ╔═╡ e49da1a2-8723-48d1-be69-944804c5d94c
let
	gridvis = GridVisualizer(Plotter=WGLMakie,dim=2)
    gridplot!(gridvis,grid)
    ax = gridvis.subplots[1][:scene]
	ptx = [grid[Coordinates][1,11]]
	pty = [grid[Coordinates][2,11]]
	# plot a thick red dot at given node
    WGLMakie.scatter!(ax,ptx,pty,markersize=10,color=:red) 
    reveal(gridvis)
end
...
[compat]
ExtendableGrids = "~0.9.15"
GridVisualize = "~0.5.2"
PlutoVista = "~0.8.14"
PyPlot = "~2.11.0"
SimplexGridFactory = "~0.5.17"
Triangulate = "~2.2.0"
WGLMakie = "~0.5.5"
"""
...
git-tree-sha1 = "9e5fa054e3cac8cf68756073ff948a2384b94c68"
...
git-tree-sha1 = "400280204788213ff93358099c1fdb63c7e09534"
...
git-tree-sha1 = "7a5969ed75a96d8b995eaf8877305192d299fa05"
